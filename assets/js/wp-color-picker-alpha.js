 ...
 *
 * Version 1.0
 * Copyright (c) 2020 Vinky Themes.
 *
 * Overwrite Automattic Iris for enabled Alpha Channel in wpColorPicker
 * Only run in input and is defined data alpha in true
 *
 * This is modified version made by Vinky Themes on the work covered by the
 * following copyright:
 *
 * Version: 2.1.4
...
( function( $ ) {
	...
	_before = '<button type="button" class="button wp-color-result"' +
		' aria-expanded="false"><span class="wp-color-result-text"></span></button>';
	...
	$.widget( 'a8c.iris', $.a8c.iris, {
		_create: function() {
			...
			if ( typeof this.options.alpha !== 'undefined' && this.options.alpha ) {
				...
				stripsWidth = ( ( emptyWidth / 2 ) - stripsMargin ) - 2;
